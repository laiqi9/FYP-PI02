...
class App:
  def __init__(self, window, window_title, video_source=0):
    ...
    self.btn_snapshot=tkinter.Button(window, text="snapshot", width=30, command=self.vid.snapshot)
    self.btn_snapshot.pack(side=tkinter.RIGHT, anchor=tkinter.NE, expand=True)
