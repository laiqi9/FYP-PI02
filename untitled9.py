...
'''
- simplified of untitled9.py - One Camera\PI37 (2)
- no differencing or anything, just camera split
- size can be changed through App class to change number of cam splits (currently 9)

TODO: get button to work :pensive:
      reincorporate back to original 
'''
